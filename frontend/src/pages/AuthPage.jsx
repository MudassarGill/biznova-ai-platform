        ...
        <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center bg-dark-900/80 backdrop-blur-xl relative z-10 border-r border-dark-800/50">
          <div className="max-w-md w-full mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {!isLogin && (
                <div className="relative">
                  ...
                  <input 
                    type="email" 
                    placeholder="Email" 
                    className="input-field pl-12 bg-dark-800/50 border-t-0 border-x-0 border-b-2 border-b-dark-600 rounded-none focus:border-b-brand-500 focus:ring-0 px-0"
                    required
                  />
                </div>
              )}
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full py-2 pr-10 bg-transparent border-b-2 border-dark-600 text-white placeholder-dark-400 focus:outline-none focus:border-brand-500 transition-colors"
                  required
                />
              </div>
            ...
            <div className="flex gap-4">
              <button type="button" className="flex-1 py-2.5 rounded-xl border border-dark-700 bg-dark-800/50 hover:bg-dark-700 flex items-center justify-center gap-2 transition-colors group">
